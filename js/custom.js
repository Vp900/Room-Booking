...
$(document).ready(function()
{
    ...
    function initHomeSlider()
    {
        if($('.home_slider').length)
        {
            ...
            // Stop slider when mouse is over the form
            $(".booking_form_container").on("mouseenter", function() {
                homeSlider.trigger("stop.owl.autoplay");
            });

            // Resume slider when mouse leaves the form
            $(".booking_form_container").on("mouseleave", function() {
    ...
    function initBookingSlider()
    {
        if($('.booking_slider').length)
        {
            ...
            $(".booking_form_container").on("mouseenter", function() {
                bookingSlider.trigger("stop.owl.autoplay");
            });

            $(".booking_form_container").on("mouseleave", function() {
                bookingSlider.trigger("play.owl.autoplay");
            });
        }
    }
